...
public class UniverseTest {
	...
	public void setUp() {
		...
		uniHeight = 4;
		numSS = 5;
		uni = Universe.generateUniverse(uniWidth, uniHeight, numSS);//width 3, height 4, 5 SolarSystems
	}
	@Test
	public void testUni() {
	...
	public void testUniSSLocations() {
		assertEquals(false, uni.hasSolarSystemAt(0, -1));//invalid SS location
		assertEquals(false, uni.hasSolarSystemAt(-1, 0));//invalid SS location
		assertEquals(false, uni.hasSolarSystemAt(uniWidth, 1));//invalid SS location
		assertEquals(false, uni.hasSolarSystemAt(1, uniHeight));//invalid SS location
	}
}
